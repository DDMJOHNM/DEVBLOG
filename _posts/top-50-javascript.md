---
title: 'Top 50 JavaScript'
description: 'JavaScript interview questions covering the event loop, closures, DOM, and async patterns'
category: Interviewing
author: 'John Mason'
date: '2026-08-19 15:42'
---

Interview notes for JavaScript. Numbered questions with short answers and examples.
...
- Identify target: Use event.target to determine the clicked element.
...
**`<script>`** — fetches and executes immediately, pausing HTML parsing. Use for critical scripts needed before render.

```html
<script src="main.js"></script>
```

**`<script async>`** — loads in parallel with HTML parsing and executes as soon as it is ready. Use for independent scripts such as analytics.

```html
<script async src="analytics.js"></script>
```

**`<script defer>`** — loads alongside HTML parsing but only runs after the document is fully parsed. Use for scripts that need a complete DOM.
...
- XMLHttpRequest supports progress tracking, which fetch() does not. (On Progress)
