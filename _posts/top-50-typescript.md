---
title: 'Top 50 TypeScript'
description: 'TypeScript interview questions covering types, interfaces, classes, and the compiler'
category: Interviewing
author: 'John Mason'
date: '2026-08-19 15:42'
---

Interview notes for TypeScript. Numbered questions with short answers and examples.

## 1. What is TypeScript and how does it differ from JavaScript?

TypeScript is a statically-typed superset of JavaScript, developed and maintained by Microsoft. It enables enhanced code maintainability and predictability.
 After compiling, TypeScript code is transpiled into standard, browser-compatible JavaScript.

 - Offers static typing
 - Incorporates modern ECMAScript syntax
 - TypeScript brings functional programming patterns, classes, and access modifiers (such as public and private)
 - Compatibility with JavaScript
 - Tooling and Extra Safety
...
Heterogeneous Enum: Defines keys with both number or string values. However, due to the mixed-type nature of
these enums, it's best to steer clear of them in most cases.
...
### Inheritance with prototypal methodology
